...
int decode_resume_notification(uint8_t *buf,
		gtp_resume_notification_t *value);
...
int decode_resume_acknowledge(uint8_t *buf,
		gtp_resume_acknowledge_t *value);

/**
 * Decodes gtp_suspend_notification to buffer.
 * @param buf
 *   buffer to store decoded values.
 * @param value
 ...
 *   number of decoded bytes.
 **/
int decode_suspend_notification(uint8_t *buf,
		gtp_suspend_notification_t *value);

/**
 * Decodes gtp_suspend_acknowledgement_t to buffer.
 * @param buf
 *   buffer to store decoded values.
 * @param value
 ...
 *   number of decoded bytes.
 */
int decode_suspend_acknowledge(uint8_t *buf,
		gtp_suspend_acknowledgement_t *value);
